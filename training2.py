...
from models.UAMRL2 import Multimodal_Affinity
...
def training(model, train_loader, optimizer, epoch, epochs):
    ...
    for batch, data in loop:
        ...
        mu_ss_private, v_ss_private, alpha_ss_private, beta_ss_private, mu_gg_private, v_gg_private, alpha_gg_private, beta_gg_private, \
            mu_sg_private, v_sg_private, alpha_sg_private, beta_sg_private, mu_gs_private, v_gs_private, alpha_gs_private, beta_gs_private, diff_loss = model(compound_sequence, data.to(device), protein_sequence, protein_img, data.to(device))
